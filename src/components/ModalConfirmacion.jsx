  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-slate-900/70 backdrop-blur-md animate-[fadeIn_0.3s_ease-out]">
      ...
      <div className="bg-white/95 backdrop-blur-xl p-6 sm:p-8 rounded-[2.5rem] shadow-[0_25px_80px_rgba(0,0,0,0.4)] w-full max-w-md border border-white/50 relative animate-[fadeIn_0.5s_ease-out] overflow-hidden">
        ...
        {/* Efecto de brillo superior idéntico a tus otros modales */}
        ...
        <div className="flex flex-col items-center text-center pt-2">
          ...
          <div className="flex items-center gap-3 w-full">
            <button
              onClick={onCancelar}
              className="flex-1 px-4 py-3.5 bg-slate-100 hover:bg-slate-200 text-slate-600 font-bold rounded-2xl transition-all duration-300 active:scale-95 shadow-sm border border-slate-200/60"
            >
              Cancelar
            </button>
            <button
              onClick={onConfirmar}
              className={`flex-1 px-4 py-3.5 text-white font-black rounded-2xl shadow-lg transition-all duration-300 active:scale-95 relative overflow-hidden group ${
                esPeligro
